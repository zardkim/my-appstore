<template>
  <div class="h-full overflow-y-auto lg:overflow-hidden lg:flex lg:flex-col">
    <!-- Header -->
    <div class="bg-gradient-to-r from-pink-500 to-rose-600 dark:from-pink-700 dark:to-rose-800 px-4 sm:px-6 lg:px-8 py-3 sm:py-4 lg:py-8 text-white">
      <div class="max-w-7xl">
        <h1 class="text-xl sm:text-2xl lg:text-4xl font-bold mb-0.5 sm:mb-1 lg:mb-2">❤️ {{ t('favorites.title') }}</h1>
        <p class="text-pink-100 dark:text-pink-200 text-xs sm:text-sm lg:text-base">{{ t('favorites.description') }}</p>
      </div>
    </div>
