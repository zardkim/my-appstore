  ...
  <div class="h-full flex flex-col">
    ...
    <div class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
      <div class="flex flex-col gap-2">
        ...
        <!-- Row 2: Search input -->
        <div class="relative">
          <input v-model="searchQuery" type="text" :placeholder="t('tips.searchPlaceholder')" class="w-full pl-9 sm:pl-10 pr-3 sm:pr-4 py-2 border border-gray-200 dark:border-gray-600 rounded-lg sm:rounded-xl focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 text-sm">
